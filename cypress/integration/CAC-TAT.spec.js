...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('Preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName')
          .type('Guerra')
          .should('have.value', 'Guerra')
          .clear()
          .should('have.value', '')
        cy.get('#email')
          .type('guerra@exemplo.com')
          .should('have.value', 'guerra@exemplo.com')
          .clear()
          .should('have.value', '')
        cy.get('#phone')
          .type('1234567890')
    ...
    it('Seleciona um arquivo simulando um frag-and-drop (tipo arrastar o arquivo até a área de upload)', function() {
        cy.get('input[type="file"]')
          .should('not.have.value')
    ...
    it('Exibe e esconde as mensagens de sucesso e erro usando o .invoke', function() {
      ...
      it.only('Encontra o gato escondido', function() {
        cy.get('#cat')
          ...
          .should('be.visible')
        cy.get('#title')
          .invoke('text', 'BRUNO GUERRA')
        cy.get('#subtitle')
          .invoke('text', 'É o cara!!!')
      })
